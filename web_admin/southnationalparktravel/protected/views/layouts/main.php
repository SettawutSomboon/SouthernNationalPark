...
<div class="container" id="page">
    ...
    'brand'=>'Southern National Park Travel',
    'brandUrl'=>'#',
...
array('label'=>'การจัดการข้อมูล','icon'=>'asterisk','items'=> array(
		...
		//array('label'=>'อัปรูปภาพใหม่','icon'=>'list', 'url'=>array('/images/index'), 'visible'=>!Yii::app()->user->isGuest),
array('label'=>'อุทยานแห่งชาติ','icon'=>'list', 'url'=>array('/dataSouthnationpark/admin'), 'visible'=>!Yii::app()->user->isGuest),
//array('label'=>'จัดการอัลบั้มรูปภาพ','icon'=>'list', 'url'=>array('/images/admin'), 'visible'=>!Yii::app()->user->isGuest),
...
array('label'=>'จังหวัด','icon'=>'list', 'url'=>array('/province/admin'), 'visible'=>!Yii::app()->user->isGuest),
		...
		array('label'=>'ลงชื่อเข้าใช้','icon'=>'lock', 'url'=>array('/site/login'), 'visible'=>Yii::app()->user->isGuest),
